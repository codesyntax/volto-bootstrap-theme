...
DEPLOY_ENV=prod
DEPLOY_HOST=volto-bootstrap-theme.example.com
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for volto-bootstrap-theme.example.com, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    volto-bootstrap-theme.example.com:
      ansible_user: root
      host: volto-bootstrap-theme
      hostname: volto-bootstrap-theme.example.com
```
...
Deploy the stack defined in `devops/stacks/volto-bootstrap-theme.example.com.yml` to the remote server with:
