...
2. Go to your repository at [collective/volto-bootstrap-theme](https://github.com/collective/volto-bootstrap-theme).
3. Click on `Settings` at the top-right corner.
4. In the left sidebar, click on `Environments`.
5. Press `New environment`.
6. Name the environment `volto-bootstrap-theme.example.com` and hit `Configure environment`.
...
|-------------|--------------|-------------|
| DEPLOY_HOST | volto-bootstrap-theme.example.com | The hostname or IP address of your Docker Swarm manager. |
...
| Name     | Value |
|----------|-------|
| LIVE_ENV | volto-bootstrap-theme.example.com |
...
- [Backend Tests Workflow](https://github.com/collective/volto-bootstrap-theme/actions/workflows/backend.yml)
- [Frontend Tests Workflow](https://github.com/collective/volto-bootstrap-theme/actions/workflows/frontend.yml)

Upon successful completion of the tests, Docker images for the Backend (`ghcr.io/collective/volto-bootstrap-theme-backend`) and Frontend (`ghcr.io/collective/volto-bootstrap-theme-frontend`) will be available.

### Initiating Manual Deployment

1. Navigate to [Manual Deployment of volto-bootstrap-theme.example.com](https://github.com/collective/volto-bootstrap-theme/actions/workflows/manual-deploy.yml).
...
- Initiate a new deployment using the `devops/stacks/volto-bootstrap-theme.example.com.yml` stack.
