...
from bootstrap.def.interfaces import IBrowserLayer
...
if site_id not in app.objectIds():
    ...
    portal_setup.runAllImportStepsFromProfile("profile-bootstrap.def:default")
    transaction.commit()

    if EXAMPLE_CONTENT:
        portal_setup.runAllImportStepsFromProfile("profile-bootstrap.def:initial")
        transaction.commit()
    app._p_jar.sync()
