/*
 * Implementation of the stylewrapper for Block Model 3, as implemented by Volto Light Theme
 *
 * See: https://github.com/kitconcept/volto-light-theme/blob/main/frontend/packages/volto-light-theme/src/components/Theme/StyleWrapperV3.jsx
 *
 */
