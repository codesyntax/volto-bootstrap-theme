...
import { emptyAccordion, getPanels } from '@eeacms/volto-accordion-block/components/manage/Blocks/Accordion/util';
...
const Edit = (props) => {
  ...
  return (
    <>
      ...
      <fieldset className="accordion-block bootstrap-container">
        <legend
          onClick={() => {
            setSelectedBlock({});
